...
namespace david63\inactivememb;
...
class ext extends base
{
	...
	*/
	public function is_enableable()
	{
		...
		$is_enableable = phpbb_version_compare(PHPBB_VERSION, '3.1.7-RC1', '>=');
		...
		if (!$is_enableable)
		{
			...
			{
				$this->container->get('language')->add_lang('ext_enable_error', 'david63/inactivememb');
			}
			else
			{
				$this->container->get('user')->add_lang_ext('david63/inactivememb', 'ext_enable_error');
			}
		}
